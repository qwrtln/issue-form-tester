...
\addscenariosection{1}{Cooperative Scenario}{Dwell Dwell Your Boat}{\images/magic_arrow.png}

\begin{multicols*}{2}

\textbf{Author:} A pirate
...
\textbf{Starting Resources:} 10 \svg{gold}, 4 \svg{building_materials}, 2 \svg{valuables}
