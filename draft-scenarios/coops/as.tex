...
\addscenariosection{1}{Cooperative Scenario}{as}{\images/magic_arrow.png}
...
\begin{itemize}A Few of each \svgunit{bronze} Units
  \itemA Few \svgunit{gold}en Units with the lowest Recruitment cost
  \itemA Pack \svgunit{gold}en Units with the highest Recruitment cost

\end{itemize}

\textbf{Town Buildings:} \svgunit{silver} Dwelling, Citadel
