...
\addscenariosection{1}{Cooperative Scenario}{Bźdźiągwa Stara}{\images/magic_arrow.png}

\begin{multicols*}{2}

\textbf{Author:} Bździch

\textbf{Source:} nima

\textit{Pewnego dnia w Bździszewie...}
...
\textbf{Player Count:} 1 or 5

\textbf{Starting Resources:} 35 \svg{gold}, 1 \svg{building_materials}, 5 \svg{valuables}
