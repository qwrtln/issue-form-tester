...
\addscenariosection{1}{Cooperative Scenario}{time}{\images/magic_arrow.png}
...
\textbf{Additional Bonus:} random artifact
...
Find all legion artifacts

\subsection*{\MakeUppercase{Defeat Conditions}}
Find no legion artifacts
