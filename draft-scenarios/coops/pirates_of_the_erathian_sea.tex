...
\addscenariosection{1}{Cooperative Scenario}{Pirates of the Erathian Sea}{\images/magic_arrow.png}

\begin{multicols*}{2}

\textbf{Author:} Jack Sparrow

\textbf{Source:} Hollywood

\textit{Thank you for submitting your scenario! Please fill in the form below.
Please don't remove the New Scenario: prefix from the title!}

\subsection*{\MakeUppercase{Scenario Length}}

This Scenario is played over 10 Rounds.

\subsection*{\MakeUppercase{Player Setup}}

\textbf{Player Count:} 1-2

\textbf{Starting Resources:} 40 \svg{gold}, Y \svg{building_materials}, Z \svg{valuables}
